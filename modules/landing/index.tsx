...
import bg_text from "@/public/landing/Vector 7.png"
...
export const Landing = () => {
  return (
    <div className="mainContainer flex flex-col justify-center items-center bg-[#f8dbe9] overflow-hidden ">
        ...
        <div className="relative w-full h-full flex flex-col justify-start items-center py-36 ">
          ...
          <div className="z-20 relative flex w-screen justify-center items-center h-fit py">
              <div className="flex flex-col max-w-[700px] sm:w-[80%] relative ">
                ...
                <h1 className="z-20 text-[50px] md:text-[57px] sm:text-[75px] text-[#480068] font-huskyStash mainly-stroke text-center">Pesta Rakyat Komputer</h1>
                <div className=" right-[10%] bottom-0 md:-right-5 md:-bottom-4  sm:right-0 sm:-bottom-2 absolute flex flex-col items-center">
                  <h1 className="z-20 text-[25px] sm:text-[36px] text-[#FFE497] font-huskyStash -rotate-12 text-shadow ">2025</h1>
          ...
          <p className="z-20 hidden sm:block text-[32px] font-orelegaOne">lorem Ipsum</p>
          ...
          <button className="w-[230px] h-[40px] sm:w-[221px] sm:h-[34px] mt-10 sm:mt-8 bg-[#F62455] rounded-[10px] flex gap-[10px] justify-center items-center z-20 hover:shadow-xl ">
            <span className="text-[#FCFBFD] text-[16px] font-poppins z-20 ">            Mulai jelajah            </span>
            <Image src={cursorClickIcon} alt="cursor_icon" width={20} height={20} className="text-[#FCFBFD] font-poppins z-20 "/>
          </button>
      ...
      <div className="container2 relative w-screen h-[900px] sm:h-[1024px] bg-[#FFE1F9] flex flex-col justify-center items-center gap-8 pb-24 overflow-hidden">
        ...
        <div className="grid grid-cols-4 grid-rows-3 h-[900px] w-[90%] xl:size-[1100px] gap-5 z-10 p-6 sm:p-0">
          <div className="lg:col-span-3 sm:col-span-4 w-full h-full relative p-[2px] hidden sm:block  ">
            ...
            <h1 className="absolute top-[45px] z-40 right-32 text-[46px] rotate-12 text-black hidden sm:block">Calling Out <br /> Pacillians! </h1>
          ...
          <div className="col-span-4 sm:col-span-1  relative w-full  h-full py-6 sm:py-0 flex sm:hidden lg:flex flex-col sm:flex-row justify-center items-center bg">
            <Image
              ...
              loading="lazy"
            />
            <h1 className="block sm:hidden text-[#387AB4] text-[8vw] text-shadow-perak-league -rotate-[6deg] absolute right-6 -bottom-[5%]">Perak League</h1>
          </div>

          <div className=" relative  row-span-2 w-full h-full hidden lg:flex">
          <Image src={rectangleLeague}
          alt="logo_perak"
          width={220}
          height={220}
          className="z-10"
          ...
          <div className=" col-span-4 row-span-2  sm:row-span-2 lg:col-span-3 flex justify-center items-center w-full h-[600px] sm:h-full">
              ...
              <div className=" bg-[#EAE4FF] w-full h-full border-[4px] border-black">
      ...
      <div className="container3 relative w-screen h-[700px] sm:h-[800px] bg-[#F4F1FF] pt-32 overflow-hidden" style={{ backgroundImage: `url(${spottedBg.src})`, backgroundSize: '100% auto',backgroundRepeat:'no-repeat' , backgroundPosition: 'top' }}>
            ...
            <div className=" w-[90%]  mx-auto z-50 ">
              <Accordion type="single" collapsible className="z-50 w-full flex flex-col gap-5 -mt-4" >
